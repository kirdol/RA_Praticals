...
plot(scaled_b$scaled_neg_log_returns_bitcoin, type = "l", col = "blue", ylab = "Scaled Values", xlab = "Index", 
     main = "Scaled Negative Log Returns and Bitcoin Prices", ylim = range(c(scaled_b$scaled_neg_log_returns_bitcoin, scaled_b$scaled_trimmed_bitcoin_prices)))

# Add the scaled bitcoin prices to the same plot
lines(scaled_b$scaled_trimmed_bitcoin_prices, col = "red")

# Add a legend to differentiate the two lines
legend("topright", legend = c("Scaled Neg Log Returns", "Scaled Bitcoin Prices"), col = c("blue", "red"), lty = 1)
```
