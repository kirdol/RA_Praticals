...
Since the p-value is significantly bigger than 0.05, we can not reject the null hypothesis and conclude that the negative log returns series is not stationary.
...
hist(neg_log_returns_bitcoin, breaks=50, col="lightblue", 
     main="Histogram of Negative Log Returns", xlab="Negative Log Returns")
