...
# Print the results
cat("For Geneva, the 95th percentile threshold is", round(threshold_geneva, 2), "°C and the return period is approximately", round(return_period_geneva, 2), "years.\n")
cat("For Säntis, the 95th percentile threshold is", round(threshold_santis, 2), "°C and the return period is approximately", round(return_period_santis, 2), "years.\n")
cat("For Lugano, the 95th percentile threshold is", round(threshold_lugano, 2), "°C and the return period is approximately", round(return_period_lugano, 2), "years.\n")
```
...
The differences in return periods highlight the variation in elevation, geography and micro-climates of regions in Switzerland and their susceptibility to extreme heat waves. Although not similar across regions, increasing temperatures poses serious issues for all regions. As return periods are not static, in a context of climate change, the same threshold can be exceeded more frequently as average temperatures rise, leading to a decrease in return period. The results highlights our understanding of the current risk and the importance of setting clear strategies to mitigate any potentially arising risks.
