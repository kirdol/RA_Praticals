...
threshold <- 40  # Update this value based on the MRL plot inspection
...
threshold <- 40  # Adjust this value based on the MRL plot results
...
threshold <- 40  # Adjust this value as necessary
...
threshold <- quantile(summer_data$AvgTemperature, 0.90)
...
threshold <- quantile(summer_data$AvgTemperature, 0.85, na.rm = TRUE)
